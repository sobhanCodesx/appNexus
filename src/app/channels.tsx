...
export default function ChannelsScreen(){
 const {data,refreshing,refresh}=useApiResource<Paginated<Channel>>('/channels',{data:[]});
 return <Screen>
...
const styles=StyleSheet.create({content:{paddingHorizontal:layout.screenPadding,paddingBottom:90},card:{height:210,borderRadius:radii.xl,overflow:'hidden',borderWidth:1,borderColor:palette.line,marginBottom:spacing.md,backgroundColor:palette.surface},image:{...StyleSheet.absoluteFillObject},copy:{marginTop:'auto',padding:spacing.lg,backgroundColor:'rgba(3,5,9,0.68)',alignItems:'flex-end'},kicker:{color:palette.cyan,fontFamily:fontFamily.black,fontSize:8,letterSpacing:1},name:{color:palette.white,fontFamily:fontFamily.black,fontSize:22,marginTop:3},meta:{color:palette.textMuted,fontFamily:fontFamily.regular,fontSize:10,marginTop:4}});
